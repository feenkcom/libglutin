...
pub fn glutin_pixel_format_is_srgb(_ptr: *mut ValueBox<PixelFormat>) -> bool {
    _ptr.with(|pixel_format| pixel_format.srgb)
}

#[no_mangle]
pub fn glutin_pixel_format_drop(_ptr: *mut ValueBox<PixelFormat>) {
    _ptr.drop()
}